...
class fused_rings:
    def __init__(self, m, find_rings, ringIDs, graph):
        ...
        for id1, id2 in self.bonded:
            ...
            for index, cluster in enumerate(clusters):
                if id1 in cluster: c1 = index; flag1 = True;
                if id2 in cluster: c2 = index; flag2 = True;
...
class ring_analysis:
    def __init__(self, m, find_rings):
        ...
        self.cycles, self.graph = find_cycles(m, find_rings)
        ...
        if find_rings['fused-rings']: self.fused = fused_rings(m, find_rings, self.ringIDs, self.graph)
