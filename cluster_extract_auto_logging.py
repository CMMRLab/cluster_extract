...
#------------------------------------------------------------------------------------------------------------#
parent_directory = 'Examples/auto_logging'
...
interval = 500  # is the time interval that gets tallied
maxtime = 2000 # Sets the maximum time of files
...
if __name__ == "__main__":  
    ...
    for n in range(niterations):
        ...
        topofile = 'Examples/auto_logging/PFA_rep_4_carb_temp_2300K_2GPa_time_' + str(time) + 'ps_equil_equilibrated.data'
        bondfile = 'Examples/auto_logging/PFA_rep_4_carb_temp_2300K_2GPa_time_' + str(time) + 'ps_equil_equilibrated.reaxc'
        ...
        outputs, byproducts = main(m, delete_atoms, compute_bond_dists, find_rings, atom_style,
                                   files2write, parent_directory, mass_initial, N0, pflag=False)
